...
public class RegionBak {
	...
	static {
//		regionMap.put("云南省", 530000);
//		regionMap.put("台湾省", 710000);
//		regionMap.put("吉林省", 220000);
//		regionMap.put("四川省", 510000);
//		regionMap.put("安徽省", 340000);
//		regionMap.put("山东省", 370000);
//		regionMap.put("山西省", 140000);
//		regionMap.put("广东省", 440000);
//		regionMap.put("河南省", 410000);
//		regionMap.put("河北省", 130000);
//		regionMap.put("江西省", 360000);
//		regionMap.put("江苏省", 320000);
//		regionMap.put("湖南省", 430000);
//		regionMap.put("湖北省", 420000);
//		regionMap.put("海南省", 460000);
//		regionMap.put("浙江省", 330000);
//		regionMap.put("辽宁省", 210000);
//		regionMap.put("贵州省", 520000);
//		regionMap.put("福建省", 350000);
//		regionMap.put("甘肃省", 620000);
//		regionMap.put("黑龙江省", 230000);
//		regionMap.put("青海省", 630000);
//		regionMap.put("陕西省", 610000);
//
//		regionMap.put("新疆维吾尔自治区", 650000);
//		regionMap.put("广西壮族自治区", 450000);
//		regionMap.put("宁夏回族自治区", 640000);
//		regionMap.put("内蒙古自治区", 150000);
//		regionMap.put("西藏自治区", 540000);
//
//		regionMap.put("上海市", 310000);
//		regionMap.put("重庆市", 500000);
//		regionMap.put("北京市", 110000);
//		regionMap.put("天津市", 120000);
//
//		regionMap.put("香港特别行政区", 810000);
//		regionMap.put("澳门特别行政区", 820000);
		...
		regionMap.put("克孜勒苏柯尔克孜自治州", 653000);
		...
		regionMap.put("博尔塔拉蒙古自治州", 652700);
...
//		regionMap.put("县", 500200);
		...
		regionMap.put("巴音郭楞蒙古自治州", 652800);
		...
		regionMap.put("廊坊市", 131000);
		regionMap.put("延安市", 610600);
		regionMap.put("延边朝鲜族自治州", 222400);
		...
		regionMap.put("文山壮族苗族自治州", 532600);
		...
		regionMap.put("海北藏族自治州", 632200);
		regionMap.put("海南藏族自治州", 632500);
		regionMap.put("海口市", 460100);
		regionMap.put("海西蒙古族藏族自治州", 632800);
		...
		regionMap.put("湘西土家族苗族自治州", 433100);
		...
		regionMap.put("玉树藏族自治州", 632700);
		regionMap.put("玉溪市", 530400);
		regionMap.put("珠海市", 440400);
		regionMap.put("甘南藏族自治州", 623000);
		regionMap.put("甘孜藏族自治州", 513300);
...
//		regionMap.put("省直辖县级行政区划", 139000);
		...
		regionMap.put("红河哈尼族彝族自治州", 532500);
...
//		regionMap.put("自治区直辖县级行政区划", 659000);
		...
		regionMap.put("西双版纳傣族自治州", 532800);
		...
		regionMap.put("阿坝藏族羌族自治州", 513200);
		...
		regionMap.put("黄南藏族自治州", 632300);
		regionMap.put("黄山市", 341000);
		regionMap.put("黄石市", 420200);
		regionMap.put("黑河市", 231100);
		regionMap.put("黔东南苗族侗族自治州", 522600);
		regionMap.put("黔南布依族苗族自治州", 522700);
		regionMap.put("黔西南布依族苗族自治州", 522300);
